...
<body
    ...
    <header class="w-full lg:max-w-4xl max-w- text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
    ...
    <div
        ...
        <main class="flex max-w- w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[13px] leading- flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect- lg:aspect-auto w-full lg:w- shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
