        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <a href="{{ route('admin.activities.trash') }}"
                    class="text-xs font-bold text-red-500 hover:text-red-700 transition flex items-center mt-1">
                    <i class="fas fa-trash-alt mr-1"></i> Lihat Trash Bin
                    ({{ \App\Models\Activity::onlyTrashed()->count() }})
                </a>
            </div>
            <a href="{{ route('admin.activities.create') }}"
                class="bg-indigo-600 text-white px-5 py-2 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg shadow-indigo-200 flex items-center">
            ...
            <table class="w-full text-left">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr class="text-xs uppercase text-gray-400 font-black tracking-widest">
                        ...
                        <th class="px-6 py-4 text-left">Name Quest</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <span class="text-3xl mr-4 drop-shadow-sm">
                                        {{ $act->icon ?? '❓' }}
                                    </span>
